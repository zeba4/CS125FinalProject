...
// History!!!!!!!!
public class getQuestionMovies extends AsyncTask<Void,Void,Void>{
    String data = "";
    String dataParsed = "";
    ...
    protected Void doInBackground(Void... voids) {
        try {
            URL url = new URL("https://opentdb.com/api.php?amount=10&category=23&type=boolean");
...
//            }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Movies.data.setText(this.dataParsed);
        Movies.dataAnswers.setText(this.dataParsedAnswer);
