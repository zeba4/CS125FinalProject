...
//ANIMALS!!!!!
public class getQuestionMusic extends AsyncTask<Void,Void,Void>{
    String data = "";
    String dataParsed = "";
    ...
    protected Void doInBackground(Void... voids) {
        try {
            URL url = new URL("https://opentdb.com/api.php?amount=10&category=27&type=boolean");
...
//            }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Books.data.setText(this.dataParsed);
        Books.dataAnswers.setText(this.dataParsedAnswer);
